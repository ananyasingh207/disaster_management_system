...
export default function CitizenReport() {
  ...
  const submit = async (e) => {
    ...
    try {
      await api.post("/citizen/incidents", form);
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input 
                  ...
                  className={`w-full bg-slate-950 border rounded-lg px-4 py-3 text-white text-sm focus:border-blue-500 outline-none transition-all font-mono ${
                    form.address ? 'border-blue-500/50 bg-blue-500/5' : 'border-slate-700'
                  }`}
                />
              </div>
